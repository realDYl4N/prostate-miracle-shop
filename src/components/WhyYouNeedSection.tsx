    ...
    <section className="py-16 bg-background">
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <p className="text-muted-foreground font-body leading-relaxed text-lg">
          ...
          comfort. Prostate Miracle® addresses these concerns at their source with clinically-studied 
          botanicals, helping restore normal urinary function so you can sleep through the night 
