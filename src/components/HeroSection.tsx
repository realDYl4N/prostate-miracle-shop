        ...
        <div className="flex flex-col md:flex-row items-center gap-10 md:gap-16">
          ...
          <div className="flex-1 max-w-xl">
            ...
            <a href="/prostate-miracle">
              <Button size="lg" className="text-base font-bold px-10 py-6 rounded-lg shadow-[0_0_20px_hsl(var(--primary)/0.3)] animate-[glow_4s_ease-in-out_infinite] hover:scale-105 transition-all duration-300">
                Buy Now
              </Button>
            </a>
