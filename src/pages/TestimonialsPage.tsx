...
const testimonials = [
  ...
  { name: "Alan Pooley", location: "NSW, Australia", text: "This is my second order and I want to thank you for the product. I have noticed improvement across all areas of my prostate discomfort. I had tried another option for 18 months before switching to Prostate Miracle and experienced no improvement whatsoever with the prior approach. Many thanks." },
  { name: "Jun Gatmaitan", location: "Philippines", text: "I had been experiencing prostate discomfort and was looking for a natural support option. My daughter found your site while researching online and we ordered through a friend in the US. I started taking it immediately and noticed meaningful improvement after finishing the first bottle. I continued taking it and have been very happy with the ongoing results. I had tears in my eyes — thank you." },
  { name: "Warren Maines", location: "USA", text: "I have been taking Prostate Miracle for 27 days and I am genuinely impressed with the results. My urologist was pleased with my progress at my recent visit and said he doesn't need to see me for another 6 months. My family doctor also called with positive feedback. Thank you for your product — I will keep you informed." },
  { name: "Ray E. Hammack", location: "USA", text: "I had a slight burning sensation in the prostate area after long hours at my desk. Since I believe in preventative maintenance, I started taking Prostate Miracle about 3 months ago. After only three days, I noticed a very definite sense of well-being throughout the prostate area. The stinging and irritation after long periods of sitting were gone. I was genuinely surprised at how well it worked. What else can I say — buy it, try it, you'll like it and you'll never be without it." },
  { name: "Roy M. S.", location: "USA", text: "I have been using Prostate Miracle since 1999 and have had marvelous results. I was experiencing urinary discomfort and had been evaluated for prostate size concerns. After taking the recommended dosage consistently, all symptoms were alleviated. My most recent urologist visit showed meaningful improvement in prostate size. I am ecstatic with the success of Prostate Miracle." },
  { name: "Jeff Gentry", location: "USA", text: "I was waking up frequently through the night and within 2 days on the product that dropped to zero. Continuing to see great results." },
  { name: "Steve L. Wilson", location: "USA", text: "I was skeptical — even thought of returning it. Then around week four I noticed a change in urinary urgency. After another week I was sleeping through the night. Now I feel normal." },
  { name: "Frank Evans", location: "USA", text: "Urgency, frequency, low flow, dribbling — all gone within 2 days on the product." },
];
