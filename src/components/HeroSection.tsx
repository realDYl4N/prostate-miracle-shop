      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row items-center gap-10 md:gap-16">
          ...
          <div className="flex-1 max-w-xl">
            ...
            {/* Headline */}
            <h1 className="text-4xl md:text-5xl lg:text-[3.4rem] font-display font-bold leading-[1.1] mb-5 text-muted-foreground">The Prostate Formula 10,000+ 
Men Won't Stop Reordering<span className="text-primary">10,000+</span> For
